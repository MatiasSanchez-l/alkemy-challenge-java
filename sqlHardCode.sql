...
insert into subject(id, finish_time, max_places, current_places, name, shift, start_time, description, teacher_id)
value(1, 11, 20, 20, 'Programacion Basica I', 'maniana', 8, 'El programa de la asignatura pretende introducir al alumno en la programación
...
(2, 11, 1, 1, 'Informatica', 'maniana', 8, 'Familiarizar al alumno en los conceptos y términos básicos para obtener
conocimientos referidos a las tecnologías de la información y las comunicaciones.', 3),
(3, 10, 20, 20, 'Base de Datos I', 'tarde', 6, 'El programa de la asignatura pretende introducir al alumno en los conceptos, modelado,
...
(4, 11, 20, 20, 'Programacion Web I', 'maniana', 8, 'El	programa	de	la	asignatura	pretende	introducir	al	alumno	en	el	programación	Web,	de	
